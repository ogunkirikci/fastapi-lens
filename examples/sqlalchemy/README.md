...
The example creates `fastapi_latensight_example.db` in the working directory. Stop the
application cleanly so the Latensight and engine registrations are released.
